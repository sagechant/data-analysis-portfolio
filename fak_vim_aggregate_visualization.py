...
metrics_to_analyze = [
    ...
    'vimentin_intensity_integrated',
    'fak_intensity_mean',
    'fak_intensity_integrated',
    'pcc',
    'm1_coeff',
    'm2_coeff',
    'icq',
...
def plot_interactive_time_courses(stats_df, metrics, area_col, area_label, n_tracks, min_len, outfile_html, outfile_png):
    ...
    fig.update_layout(
        ...
        hovermode="x unified", height=300 * num_metrics, showlegend=False # Hide legend for cleaner look
    )
...
if __name__ == "__main__":
    ...
    if not combined_data.empty:
        ...
        if not filtered_data.empty and num_filt_tracks > 0: # Check if tracks remain
            ...
            final_metrics = get_final_metrics(prepared_data, metrics_to_analyze, area_col)

            if final_metrics:
                # <<< ADDED: Convert final metric AND coordinate columns to numeric >>>
                print("\nConverting relevant columns to numeric...")
                # Ensure 'x' and 'y' are included if they exist
                ...
                # Essential columns might be coordinates and area for basic analysis
                ...
                # 10. Plot Correlation Heatmap (PNG only)
                ...
                # 11. Plot Trajectories (HTML and PNG)
                ...
                # 12. Print Head of Filtered Data
